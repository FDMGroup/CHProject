...
$t->get_ok('/')->text_is(title => 'Welcome')->context_like(qr/Mojolicious/);
...
$t->get_ok('/consentToAct')->text_us( title => 'Consent to Act')->content_like(qr/3 characters/)
...
$t->get_ok('/summary')->text_is( title => 'Summary')->context_like(qr/changed the name to/)
